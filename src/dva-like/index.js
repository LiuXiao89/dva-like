/**
 * 使用 useReducer useContext useMemo .. 等 模拟一个 dva 玩玩
 */
...

{
  ...
  if (v < 168) console.error('dva-like is only support in React version upper than 16.8, please update your React version');
}
